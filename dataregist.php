...
<body>
    ...
    <div class="container-fluid"> <a class="navbar-brand" href="#">
      ...
      <div class="collapse navbar-collapse" id="navbar11">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"> <a class="nav-link" href="regis.php">Register User</a> </li>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-center" style=""><b>Data Register</b></h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="table-responsive">
            <table class="table table-bordered ">
              ...
              $select = mysql_query("SELECT * FROM login") or die(mysql_error());
              while ($data = mysql_fetch_array($select)){
                ?>
                <tr>
                  <td>
                    <?php echo $data['id_use']; ?>
                  </td>
                  <td>
                  ...
                  <td>
                  <a href="edituser.php?username=<?php echo $data['username'];?>;" onclick="return warning();"> Edit </a>
                  <a href="deleteuser.php?username=<?php echo $data['username'];?>;" onclick="return warning();"> Delete </a>
                </td>
                <?php
              }
              ?>
