    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 p-4">
          <h3 class="mb-3 text-center">Input Data Pemgembalian</h3>
          <form action="cout.php" method="POST">
            <div class="form-row">
            ...
            <div class="form-row">
              <div class="form-group col-md-12"> Jumlah Kamar<input type="text" name="jumlah" class="form-control" id="form40" required="required"> </div>
            </div>
