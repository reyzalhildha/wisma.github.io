...
$query = mysql_query("SELECT * FROM login WHERE username ='$username'"); //get the data that will be updated
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 p-4">
          <h3 class="mb-3 text-center">Edit Username</h3>
          <form action="cedit.php" method="POST">
            <div class="form-row">
              <div class="form-group col-md-12"> <input type="text"  disabled="disabled" class="form-control" id="form36" name="username" value="<?php echo $data['username']; ?>"> </div>
            </div>
            <div class="form-group"> <input type="text" class="form-control" id="form38" name="password" required="required" value="<?php echo $data['password']; ?>"> 
            </div>
