...
<body>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-center"><b>Data Booking Wisma</b></h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="table-responsive">
            <table class="table table-bordered ">
              ...
              $select = mysql_query("SELECT * FROM reservasi INNER JOIN tb_tamu ON reservasi.no_ktp=tb_tamu.no_ktp ORDER BY no_pesanan DESC") or die(mysql_error());
    ...
    ?>
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="edit.php?no_pesanan=<?php echo $data['no_pesanan'];?>;" onclick="return warning();"> Edit </a>
                    <a href="delete.php?no_ktp=<?php echo $data['no_ktp'];?>;" onclick="return warning();"> Delete </a>
                  </td>
                </tr>
                <?php
      }
